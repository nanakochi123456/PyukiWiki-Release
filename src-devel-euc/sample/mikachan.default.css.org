...
/* $Id: mikachan.default.css.org,v 1.192 2012/01/31 10:12:00 papu Exp $ */
/* Code=Shift-JIS */

/* Mikachan Japanese font - http://mikachan.sourceforge.jp/ */
/* Convert Tips - http://www.adobe.com/jp/joc/devnet/dreamweaver/articles/html5pack_css3_part4.html */
/* mikachan.??? - Original												*/
/* mikachan-P.??? - Proportional										*/
/* mikachan-PB.??? - Proportional Bold									*/
/* mikachan-PS.??? - Proportional										*/
/* prase to skin dir or													*/
/* url of adding directory of [../fonts/] of $::data_pub of fonts/ dir	*/

@font-face{
	font-family:'mikachan';
		src:
			url('./mikachan.eot?')	format('oldIE'),
			url('./mikachan.woff')	format('woff'),
			url('./mikachan.ttf')	format('truetype'),
...
body,td {
	...
	margin-right:2%;
	font-size:90%;
	font-family:mikachan, verdana, arial, helvetica, Sans-Serif;
}
...
/*	background-image:url(http://papermashup.com/demos/php-graph/images/bargraph.gif);	*/
	...
	color:#fff;
	height:25px;
	font-family:mikachan, Arial, Helvetica, sans-serif;
	font-size:12px;
	line-height:1.9em
}
