...
# $Id: smedia.inc.pl,v 1.65 2011/12/31 13:06:11 papu Exp $
#
...
$smedia::twitter{"data-via"}=""							# ユーザー
	if(!defined($smedia::twitter{"data-via"}));
$smedia::twitter{"data-text"}=""						# テキスト
	if(!defined($smedia::twitter{"data-text"}));
$smedia::twitter{"data-related"}=""						# 奨励
	if(!defined($smedia::twitter{"data-related"}));
$smedia::twitter{"data-hashtags"}=""					# ハッシュタグ
	if(!defined($smedia::twitter{"data-hashtags"}));
$smedia::twitter{"data-url"}="";							# URL
...
$smedia::hatena{"url"}="";				# URL
$smedia::hatena{"title"}="";			# タイトル
...
#$smedia::mixi{"data-key"}="";			# 発行されたチェックキー
$smedia::mixi{"data-href"}="";			# URL
...
# gree
$smedia::gree{"type"}="0";			# ボタン
$smedia::gree{"height"}="20";		# 高さ
$smedia::gree{"url"}="";			# URL
...
# ローカルブックマーク
$smedia::browser{"url"}="";			# URL
$smedia::asuhbrowser{"title"}="";		# title
...
sub plugin_smedia_inline {
	...
	return ' '
		if($::form{cmd}=~/edit|admin|ad|freeze|deletecache|viewer|convert|compress|mailform|server|servererror|setting|setupeditor|versionlist/);
...
L<http://pyukiwiki.sfjp.jp/PyukiWiki/Plugin/Standard/smedia/>
