#
# $Id: Constants.pm,v 1.414 2012/01/31 10:11:57 papu Exp $
...
$RCSID = q$Id: Constants.pm,v 1.414 2012/01/31 10:11:57 papu Exp $;
$VERSION = do { my @r = (q$Revision: 1.414 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
use Carp;
