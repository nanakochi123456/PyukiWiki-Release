#
# $Id: Constants.pm,v 1.246 2012/01/31 10:12:03 papu Exp $
# Id: Constants.pm,v 2.0 2005/05/16 19:07:56 dankogai Exp
# "Jcode.pm" version 2.7 $$
#
package Jcode::Constants;
use vars qw($RCSID $VERSION);
$RCSID = q$Id: Constants.pm,v 1.246 2012/01/31 10:12:03 papu Exp $;
$VERSION = do { my @r = (q$Revision: 1.246 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
use Carp;
use Exporter;
