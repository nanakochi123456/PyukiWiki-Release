#
# $Id: NoXS.pm,v 1.172 2011/12/31 13:06:14 papu Exp $
...
$RCSID = q$Id: NoXS.pm,v 1.172 2011/12/31 13:06:14 papu Exp $;
$VERSION = do { my @r = (q$Revision: 1.172 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
use Carp;
