#
# $Id: NoXS.pm,v 1.330 2012/03/18 11:23:56 papu Exp $
...
$RCSID = q$Id: NoXS.pm,v 1.330 2012/03/18 11:23:56 papu Exp $;
$VERSION = do { my @r = (q$Revision: 1.330 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
use Carp;
