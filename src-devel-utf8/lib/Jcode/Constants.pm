#
# $Id: Constants.pm,v 1.324 2012/03/18 11:23:56 papu Exp $
...
$RCSID = q$Id: Constants.pm,v 1.324 2012/03/18 11:23:56 papu Exp $;
$VERSION = do { my @r = (q$Revision: 1.324 $ =~ /\d+/g); sprintf "%d."."%02d" x $#r, @r };
